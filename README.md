...
![Baking Frenzy responsive screenshot](readme-images/amiresponsive.png)
...
* As a user I want to be inspired by or get some idea from the photo gallery provided in the site.
...
* As a user I want that in the event that I couldn't find what I'm looking for on the site, there will be a way to let the site owner know.
...
* As a user I want to see what people have to say about Baking Frenzy through the feedback or testimonials.
* As a user I want to be able to let the site know that I want to get updated of promos and news through signing up to their newsletter.
...
one under the other or just sit side by side. Normally they are displayed 1 per page so the user 
can have a clear view. The initial plan/design drawn on wireframes were not 100% executed 
...
The website initially loads the home page or landing page (index.html) which displays a 
...
From the Home page, navigation links on the upper right hand of the screen are always 
accessible and just a click away. Alongside the navigation links sits the Logo and Logo name
which helps the user be reminded that they are definitely in the correct 
...
by the FontJoy website. Plus, I also would want to try out a new, artsy and modern look on fonts.
On some of my header text, I used them together side by side to create a modern and unique look.
  ...
  * 'Lora' cursive is used to provide contrast to the main font and I think provides 
      a more feminine look which I believe suits the site's colour 
      scheme well. I also decided to use it since cursive usually is used to highlight some significant 
...
Baking Frenzy Cakes is a very easy and enjoyable website, warm to the eyes and 
offers a lot of visuals to give the users a better experience in choosing the 
cake they are looking for or even just to get an idea. Tremendous work is done
to provide clear and appealing images/photos with a very minimal stretch/pixelation 
that can't be avoided in some circumstances. The website I believe will be 
enjoyable to the user, the mouth-watering cakes will urge the user to go to the
...
types in the website. Users will be encouraged to click it being animated and
...
![What are you looking for?](readme-images/cupcake-icon.png)
...
* ### Cake Products
  ...
  * The Cake Products page contains all the available products, but it's divided into different 
    sections and grouped them for ease of navigation.
...
font for uniformity and a neat look.
  * This gallery could help the users to decide what type of cake they might like and all the
possibilities.
...
just images, unlike the other page wherein title and description of each was provided. 
  * This gallery was created using a grid for better responsiveness.
...
![Sign up Form](readme-images/signup.png)
   ...
   * This form only does validation of input fields at the moment and when the user clicks on 
...
* Some items like cake essentials like candles, toppers, boxes and packaging 
...
* I am happy with the over  all performance based on the test results. 
...
* Most of the photos belong to myself, but I took a few from [Pexels](https://www.pexels.com/) 
...
* The Flex and CSS Grid was learned from the Geek for Geeks YouTube channel [YouTube tutorial](https://www.youtube.com/).
...
* I used the [W3C Validator](https://validator.w3.org/) and [Jigsaw Validator](https://jigsaw.w3.org/css-validator) for my HTML and CSS code testing. 
...
2. I then selected the `Pages` menu on the sidebar.
3. In the first dropdown menu labeled `Source` I selected the branch of the name `main` from the dropdown.
4. In the next dropdown labeled `/root` I left as the default option.
5. Selected Save

> I then received a notification from GitHub that my project is being deployed and after about 1 minute & 
> a couple of refreshes of the page it was ready and live.
...
my mentor [Precious Liege](https://www.linkedin.com/in/precious-ijege-908a00168/),
